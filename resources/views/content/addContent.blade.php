...
@section('content')
    ...
    <div class="content">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Añadir nuevo punto principal</div>

                    <div class="card-body">
                        <form action="{{ route('content.saveNewContent') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3 col-12 ">
                                ...
                                <select name="id" class="form-control text-uppercase" required>
                                    ...
                                    @foreach ($contents as $content)
                                        <option value="{{ $content->content_id}}">{{ $content->content_number }}.- {{ Str::limit($content->content_description, 60 ) }}</option>
                                    @endforeach
                                </select>
                                @error('id')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            ...
                            <div class="mb-3 col-12 ">
                                <label for="description" class="form-label">Descripción del nuevo punto (sin número de referencia)</label>
                                <input type="text" name="description" class="form-control text-uppercase" required>
                                @error('description')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div> 
                            <div class="col-12 row">
                                <div class="col-6 mb-3 p-3  border-start-1">
                                    <label for="points" class="form-label">[OPCIONAL] Subpuntos del punto: </label>
                                ...
                                <div class="col-6 mb-3 p-3  border-start-1">
                                    <label for="archivo" class="form-label">[OPCIONAL] Documento del punto</label>
