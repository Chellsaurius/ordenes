            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <table class="table table-striped dt-responsive table-bordered nowrap"  style="width:100%">
                            <thead>
                                <tr>
                                    <th>
                                ...
                                @foreach ($comisions as $comision)
                                    <tr class="whitespace-nowrap">
                                        ...
                                        <th>
                                            ...
                                            <a href="{{ route('comision.details', $comision->comision_id) }}" class="btn btn-outline-success">Más detalles</a>
