                            ...
                            <tbody>
                                @foreach ($comisions as $comision)
                                    <tr class="whitespace-nowrap">
                                        ...
                                        <th>
                                            <a href="{{ route('comision.GPdetails', $comision->comision_id) }}" class="btn btn-outline-success">Participantes</a>
                                            @if ($comision->comision_id == 1)
                                                <a href="{{ route('comision.GPRecords', $comision->comision_name) }}" class="btn btn-outline-success">Participaciones</a>
                                            @endif
