...
@section('content')
    ...
    <div class="content">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-uppercase">Lista de puntos del oden del día dados de baja</div>
                            ...
                            <tbody>
                                @foreach ($pendings as $pending)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('pending.enable', $pending->pending_id) }}" class="btn btn-outline-primary btn-sm"
                                                onclick="return confirm('¿Seguro que desea dar de alta este punto?')">Habilitar</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
