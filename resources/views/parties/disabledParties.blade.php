...
@section('content')
    ...
    <div class="content">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Lista de partidos dados de baja</div>
                            ...
                            <tbody>
                                @foreach ($parties as $party)
                                    <tr >
                                        ...
                                        <td class="text-uppercase">{{ $party->party_acronym }}</td>
                                        <td class="text-uppercase" >
                                        ...
                                        <td class="" >
                                            ...
                                            <a href="{{ route('party.enableParty', $party->party_id) }}" class="btn btn-outline-success" onclick="return confirm('¿Seguro que desea dar de alta este partido?')">Activar</a>
                                        </td>
                                    </tr>
